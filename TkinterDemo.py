...
root=Tk()
root.geometry("455x370")
root.title("My Tkinter Example")
root.resizable(width=False,height=False)

l_info=Label(root,text="ID Info")
l_info.place(x=350,y=100)

l_chair=Label(root,text="Chair - 101")
l_chair.place(x=350,y=120)

l_table=Label(root,text="Table - 102")
l_table.place(x=350,y=140)
